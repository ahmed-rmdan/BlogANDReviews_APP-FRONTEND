...
return(
           <section className="flex flex-col  h-[1300px]  w-full justify-around p-2
            items-center text-white bg-[#e5e7eb] text-[2.5px] sm:text-[3px]   lg:text-[3.5px]  xl:text-[4px] 2xl:text-[4.5px]    ">
                      <div className="flex flex-col justify-between w-full min-h-[1200px] items-center ">
                      ...
                      <Link href={'/posts'} className="h-[55px] w-[10%] flex items-center justify-center text-[5.5em] rounded-2xl font-extrabold bg-[#cb1b16] ">
                                 ALL POSTS
                      </Link>
