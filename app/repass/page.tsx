         ...
         <div className="flex flex-col items-center justify-start bg-white p-6 w-[97%] sm:w-[85%] xl:w-[55%] 2xl:w-[50%] rounded-2xl gap-[25px] ">
            <h1 className="w-full underline font-extrabold text-main text-[8em] text-center"> Reset Password</h1>
             <form className="flex flex-col items-center w-[95%] sm:w-[70%] lg:w-[60%] gap-[15px] text-[3em]">
                    <Label className="text-main text-center">* We will send a message to your email account to reset a new password</Label>
                     <Input type="email" placeholder=" Email" />
                    {/* <p className="text-main font-semibold ">dsadsadsa</p> */}
                   
                    <Button type="submit" className="bg-main text-sec font-bold sm:text-[1.4em] w-[30%] sm:w-[20%] hover:bg-gray-500 hover:cursor-pointer">Send</Button>
                    {/* <p></p> */}
             </form>
